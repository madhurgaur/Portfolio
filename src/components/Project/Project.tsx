        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <a href="https://github.com/madhurgaur/Smart-Spend" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://smart-spend-two.vercel.app/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>SmartSpend</h3>
              <p>
              SmartSpend is an AI-driven personal finance platform that makes it easy for users to track expenses, monitor budgets, and gain smart insights into their daily financial habits — all in one intuitive interface.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/madhurgaur/gptclonefe/" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://shiny-liger-86dd87.netlify.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Gpt Clone with Beautiful Design</h3>
              <p>A GPT Clone featuring a stunning, modern UI that delivers a smooth and engaging view. Built to replicate GPT functionality with clean design, responsive layout</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
                <a href="https://github.com/madhurgaur/courseSell-Frontend" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              <h3>Course Selling App with Admin Dashboard</h3>
              <p>A fully functional Course Selling Website with an integrated Admin Panel, allowing seamless course management, user enrollment tracking, and content updates. Designed for educators and creators to effortlessly publish, sell, and manage courses with a smooth and user-friendly experience.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
